...
class Movie(models.Model):
    ...
    directors = models.ManyToManyField(Actor, verbose_name="режисер", related_name="film_director", default=None,
                                       blank=True)
    actors = models.ManyToManyField(Actor, verbose_name="актёры", related_name="film_actor", default=None,
                                    blank=True)
    genres = models.ManyToManyField(Genre, verbose_name="жанры", related_name="film_genre", default=None, blank=True)
    ...
    fees_in_usa = models.PositiveIntegerField("Сборы в США", default=0, blank=True,
                                              help_text="указать сумму в долларах")
    fees_in_world = models.PositiveIntegerField("Сборы в мире", default=0, blank=True,
                                                help_text="указать сумму в долларах")
